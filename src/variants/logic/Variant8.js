    ...
    render() {
        return (
            <div className="box l8">
                ...
                <div className="block l8b1">

                </div>
                <div className="block l8b2">
                </div>
                <div className="finish">
                </div>

                <div className="block l8b3">
                    <br/>
                </div>
                <div className="block l8b4">
                    <br/>
                </div>
                <Draggable axis="y" bounds={"parent"}>
                    <div className="block l8b5">
                        2
                        <br/>
                    </div>
                </Draggable>
                <Draggable axis="x" bounds="parent">
                    <div className="block l8b6">
                        1
                        <br/>
                    </div>
                </Draggable>
                <Draggable axis="y" bounds="parent">
                    <div className="block l8b8">
                        4
                        <br/>
                    </div>
                </Draggable>
                <Draggable axis="x" bounds="parent">
                    <div className="block l8b10">
                        3
                        <br/>
                    </div>
                </Draggable>
                <div className="block l8b7">

                </div>
                <div className="block l8b9">
